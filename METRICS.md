...
| Measure | Value | Notes |
|---|---:|---|
| POIs in `pois.geojson` | 1152 | the curated place canon |
| Records in the 33 thematic files | 1531 | pre-merge; not searchable or card-able yet (`[12-P0-1]`) |
| **Curated places, total** | **2,683** | |
| Description of 60+ words | 1126 · **97.7%** | measured on `notes`; 26 still thin |
| Has an image | 707 · **61.4%** | |
| Has an ancient source | 487 · **42.3%** | |
| — of `confidence: high` POIs | 432 / 487 · **88.7%** | the target set for `[09-P0-1]` |
| Categories with a "what happened here" paragraph | 53 / 60 · **88.3%** | covers 1087/1152 POIs · missing: beneficiarii_station, bath, harbor, domus, vicus, gymnasium, courier_post |
...
| 2026-08-30 | 1152 | 97.7% | 61.4% | 42.3% | 0 errors |
