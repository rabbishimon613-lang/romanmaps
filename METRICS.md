...
| Records in the 30 thematic files | 1464 | pre-merge; not searchable or card-able yet (`[12-P0-1]`) |
| **Curated places, total** | **1,961** | |
| Description of 60+ words | 497 · **100.0%** | measured on `notes`; 0 still thin |
| Has an image | 266 · **53.5%** | |
| Has an ancient source | 196 · **39.4%** | |
| — of `confidence: high` POIs | 177 / 248 · **71.4%** | the target set for `[09-P0-1]` |
...
| 2026-08-24 | 497 | 100.0% | 53.5% | 39.4% | 0 errors |
