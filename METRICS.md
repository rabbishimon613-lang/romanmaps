...
| **Curated places, total** | **1,977** | |
| Description of 60+ words | 497 · **100.0%** | measured on `notes`; 0 still thin |
| Has an image | 284 · **57.1%** | |
| Has an ancient source | 200 · **40.2%** | |
| — of `confidence: high` POIs | 181 / 248 · **73.0%** | the target set for `[09-P0-1]` |
...
| 2026-08-24 | 497 | 100.0% | 57.1% | 40.2% | 0 errors |
