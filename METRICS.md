...
| Measure | Value | Notes |
|---|---:|---|
| POIs in `pois.geojson` | 520 | the curated place canon |
| Records in the 31 thematic files | 1480 | pre-merge; not searchable or card-able yet (`[12-P0-1]`) |
| **Curated places, total** | **2,000** | |
| Description of 60+ words | 520 · **100.0%** | measured on `notes`; 0 still thin |
| Has an image | 316 · **60.8%** | |
| Has an ancient source | 208 · **40.0%** | |
| — of `confidence: high` POIs | 188 / 257 · **73.2%** | the target set for `[09-P0-1]` |
| Categories with a "what happened here" paragraph | 52 / 52 · **100.0%** | covers 520/520 POIs |
...
| 2026-08-24 | 520 | 100.0% | 60.8% | 40.0% | 0 errors |
