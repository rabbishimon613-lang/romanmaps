...
| Records in the 29 thematic files | 1181 | pre-merge; not searchable or card-able yet (`[12-P0-1]`) |
| **Curated places, total** | **1,662** | |
...
| Cross-file name collisions (<150 m) | 124 | the dedupe backlog `[12-P0-1]` has to resolve |
...
| 2026-08-20 | 481 | 100.0% | 53.2% | 36.8% | 0 errors |
