...
| Measure | Value | Notes |
|---|---:|---|
| POIs in `pois.geojson` | 1196 | the curated place canon |
| Records in the 33 thematic files | 1559 | pre-merge; not searchable or card-able yet (`[12-P0-1]`) |
| **Curated places, total** | **2,755** | |
| Description of 60+ words | 1170 · **97.8%** | measured on `notes`; 26 still thin |
| Has an image | 724 · **60.5%** | |
| Has an ancient source | 487 · **40.7%** | |
| — of `confidence: high` POIs | 432 / 515 · **83.9%** | the target set for `[09-P0-1]` |
| Categories with a "what happened here" paragraph | 53 / 60 · **88.3%** | covers 1131/1196 POIs · missing: beneficiarii_station, bath, harbor, domus, vicus, gymnasium, courier_post |
...
| Cross-file name collisions (<150 m) | 156 | the dedupe backlog `[12-P0-1]` has to resolve |
...
| 2026-08-30 | 1196 | 97.8% | 60.5% | 40.7% | 0 errors |
