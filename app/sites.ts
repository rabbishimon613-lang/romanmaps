...
export const SITES: SiteInfo[] = [
  ...
  { slug: "djemila",     display: "Djemila (Cuicul)",     province: "Numidia",        modernCountry: "Algeria",     center: [5.7350, 36.3200], zoom: 17,
    founded: "96 CE by Nerva",
    blurb: "Mountain colony of veterans, contemporary with Timgad. Its stepped forum climbs the hillside." },
  ...
  { slug: "jerash",      display: "Jerash (Gerasa)",      province: "Arabia Petraea", modernCountry: "Jordan",      center: [35.8920, 32.2780], zoom: 16,
    founded: "170 BCE (Seleucid)",
    blurb: "Best-preserved of the Decapolis cities. Oval forum, colonnaded cardo, Temple of Artemis." },
  ...
  { slug: "baalbek",     display: "Baalbek (Heliopolis)", province: "Syria",          modernCountry: "Lebanon",     center: [36.2040, 34.0060], zoom: 17,
    founded: "1st c. BCE (Roman colony)",
    blurb: "Temple of Jupiter — one of the largest sanctuaries in the empire. Still under construction in Trajan's day." },
  ...
  { slug: "trier",       display: "Trier (Augusta Treverorum)", province: "Gallia Belgica", modernCountry: "Germany", center: [6.6440, 49.7520], zoom: 15.5,
    founded: "16 BCE by Augustus",
    blurb: "Roman capital of northern Gaul. Later imperial residence and one of the Empire's biggest cities. In 117 CE, a booming provincial capital." },
  { slug: "xanten",      display: "Colonia Ulpia Traiana (Xanten)", province: "Germania Inferior", modernCountry: "Germany", center: [6.4415, 51.6600], zoom: 16,
    founded: "~100 CE by Trajan",
    blurb: "Trajanic colonia on the Rhine, named for the emperor. Fresh-built at our 117 CE snapshot — mostly veterans of the Rhine legions." },
  ...
  { slug: "athens",      display: "Athens (Roman Agora)", province: "Achaea",         modernCountry: "Greece",      center: [23.7260, 37.9750], zoom: 17,
  ...
  { slug: "merida",      display: "Mérida (Emerita Augusta)", province: "Lusitania",  modernCountry: "Spain",       center: [-6.3390, 38.9160], zoom: 16,
    founded: "25 BCE by Augustus",
    blurb: "Capital of Lusitania, founded for veterans of the Cantabrian wars. Its theatre, amphitheatre, and aqueducts are among Spain's best preserved." },
  ...
  { slug: "tivoli",      display: "Tibur (Tivoli)",       province: "Italia",         modernCountry: "Italy",       center: [12.7980, 41.9640], zoom: 16.5,
    founded: "traditional 1215 BCE (Sabine)",
    blurb: "Hillside retreat above the Aniene falls. Old sanctuary of Hercules Victor, favored by Rome's senatorial class. Hadrian's villa was still on the drawing board." },
  { slug: "palestrina",  display: "Praeneste (Palestrina)", province: "Italia",       modernCountry: "Italy",       center: [12.8970, 41.8370], zoom: 16.5,
    founded: "7th c. BCE",
    blurb: "Home to the Sanctuary of Fortuna Primigenia — a vast terraced complex climbing the hillside, one of the most ambitious pieces of architecture the Republic ever built." },
  { slug: "pozzuoli",    display: "Puteoli (Pozzuoli)",   province: "Italia",         modernCountry: "Italy",       center: [14.1210, 40.8260], zoom: 16,
    founded: "194 BCE (Roman colony)",
    blurb: "Italy's main port for eastern grain and luxury goods before Portus took over. Its Flavian amphitheatre — the third-largest in the empire — was newly built at our snapshot." },
  ...
  { slug: "capua",       display: "Capua (S. Maria Capua Vetere)", province: "Italia", modernCountry: "Italy",      center: [14.2590, 41.0830], zoom: 16,
  ...
  { slug: "beneventum",  display: "Beneventum (Benevento)", province: "Italia",       modernCountry: "Italy",       center: [14.7770, 41.1300], zoom: 16,
    founded: "268 BCE (Latin colony)",
    blurb: "Terminus of the Via Appia and starting point of the Via Traiana. Trajan's Arch here was dedicated in 114 CE — three years old at our snapshot." },
  ...
  { slug: "brescia",     display: "Brixia (Brescia)",     province: "Italia",         modernCountry: "Italy",       center: [10.2220, 45.5390], zoom: 16.5,
    founded: "89 BCE (Roman municipium)",
    blurb: "Northern-Italy city under the Alps. Vespasian's Capitolium — three temples in one — was newly built and dominated the forum." },
  { slug: "milan",       display: "Mediolanum (Milan)",   province: "Italia",         modernCountry: "Italy",       center: [9.1870, 45.4630], zoom: 15,
    founded: "590 BCE (Insubres); Roman 222 BCE",
    blurb: "The largest city in northern Italy. In 117 CE, a booming provincial hub — not yet the imperial residence it would become in the 3rd century." },
  { slug: "rimini",      display: "Ariminum (Rimini)",    province: "Italia",         modernCountry: "Italy",       center: [12.5730, 44.0580], zoom: 16,
    founded: "268 BCE (Latin colony)",
    blurb: "The pivot of Roman north — the Via Flaminia met the Via Aemilia here. Its Arch of Augustus (27 BCE) and Bridge of Tiberius (21 CE) both still stand." },
  ...
  { slug: "luni",        display: "Luna (Luni)",          province: "Italia",         modernCountry: "Italy",       center: [10.0200, 44.0620], zoom: 16.5,
    founded: "177 BCE (Roman colony)",
    blurb: "The marble port. All the white Carrara marble that clad imperial Rome shipped from here." },
];
